...
class GetImaging:
    ...
    def extractAxialSlices(single_lead, CTimaging_trans, CTimaging_orig,
        ...
        for idx, l in enumerate(levels, start=1):
            ...
            intensity[l], box[l], _ = GetImaging.get_axialplanes(rot_contact_coordinates[l], filenameCT, unit_vector_rawCT,
                                                                 window_size=extractradius)
    ...
    def orient_intensityPeaks(intensity, noPeaks=2):
        ...
        fft_part = fft_intensities[noPeaks]  # Reason for indexing is not quite clear here. results more accurate when not
