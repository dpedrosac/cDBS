...
subj_folder = os.path.join("/media/storage/cDBS/data/NIFTI/subj2/")
...
for idx, seq in enumerate(file_id_noDTI):
    ...
    original_image = ants.image_read(os.path.join(subj_folder, seq))
    ...
    save_filename = os.path.join(output_folder, subj_folder, "bc_" + seq)
