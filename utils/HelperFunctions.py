...
# TODO: HelperFunctions have been structured in different classes. Major change is necessary in order to make it run. If everything is functional, delete the former part
