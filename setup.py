...
"""A setuptools-based setup module for the Imaging Toolbox which is supposed to analyse imaging data from DBS
patients"""
...
setup(
    ...
    url='https://github.com/dpedrosac/cDBS',
    classifiers=[
    ...
    cmdclass={"installation_folders": CMakeBuild},
